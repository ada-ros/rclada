...
package RCL.Services.Impl is
   ...
   function To_C_Service (C : Rcl_Rcl_Service_H.Rcl_Service_T) return C_Service;

   function To_C (This : aliased C_Service) return access constant Rcl_Rcl_Service_H.Rcl_Service_T;
...
private
   ...
   type C_Service is tagged record
      C : aliased Rcl_Rcl_Service_H.Rcl_Service_T;
   end record;

   function To_C_Service (C : Rcl_Rcl_Service_H.Rcl_Service_T) return C_Service is (C => C);

   function To_C (This : aliased C_Service) return access constant Rcl_Rcl_Service_H.Rcl_Service_T is
     (This.C'Access);
