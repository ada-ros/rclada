...
package rcl_rcl_publisher_h is
  ...
  --/ Internal rcl publisher implementation struct.
   type rcl_publisher_impl_s is null record;   -- incomplete struct

   subtype rcl_publisher_impl_t is rcl_publisher_impl_s;  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:33

  --/ Structure which encapsulates a ROS Publisher.
  --/ Pointer to the publisher implementation
   type rcl_publisher_s is record
      impl : access rcl_publisher_impl_t;  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:39
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:36

   subtype rcl_publisher_t is rcl_publisher_s;  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:40

  --/ Options available for a rcl publisher.
  --/ Middleware quality of service settings for the publisher.
   type rcl_publisher_options_s is record
      qos : aliased rmw_rmw_types_h.rmw_qos_profile_t;  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:46
      allocator : aliased rcl_rcl_allocator_h.rcl_allocator_t;  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:49
      rmw_publisher_options : aliased rmw_rmw_types_h.rmw_publisher_options_t;  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:51
      disable_loaned_message : aliased Extensions.bool;  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:53
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:43
  ...
  --/ Disable flag to LoanedMessage, initialized via environmental variable.
   subtype rcl_publisher_options_t is rcl_publisher_options_s;  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:54
  ...
  --  
   ...
   function rcl_get_zero_initialized_publisher return rcl_publisher_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:64
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_get_zero_initialized_publisher";
  ...
  --  
   ...
   function rcl_publisher_init
     (publisher : access rcl_publisher_t;
      ...
      options : access constant rcl_publisher_options_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:156
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_init";
  ...
  --  
   ...
   function rcl_publisher_fini (publisher : access rcl_publisher_t; node : access rcl_rcl_node_h.rcl_node_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:190
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_fini";
  ...
  --  
   ...
   function rcl_publisher_get_default_options return rcl_publisher_options_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:206
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_get_default_options";
  ...
  --  
   ...
   function rcl_borrow_loaned_message
     (publisher : access constant rcl_publisher_t;
      type_support : access constant rosidl_runtime_c_rosidl_runtime_c_message_type_support_struct_h.rosidl_message_type_support_t;
      ros_message : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:236
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_borrow_loaned_message";
  ...
  --  
   ...
   function rcl_return_loaned_message_from_publisher (publisher : access constant rcl_publisher_t; loaned_message : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:266
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_return_loaned_message_from_publisher";
  ...
  --  
   ...
   function rcl_publish
     (publisher : access constant rcl_publisher_t;
      ...
      allocation : access rmw_rmw_types_h.rmw_publisher_allocation_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:330
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publish";
  ...
  --  
   ...
   function rcl_publish_serialized_message
     (publisher : access constant rcl_publisher_t;
      serialized_message : access constant rcutils_rcutils_types_uint8_array_h.rcutils_uint8_array_s;
      allocation : access rmw_rmw_types_h.rmw_publisher_allocation_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:370
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publish_serialized_message";
  ...
  --  
   ...
   function rcl_publish_loaned_message
     (publisher : access constant rcl_publisher_t;
      ros_message : System.Address;
      allocation : access rmw_rmw_types_h.rmw_publisher_allocation_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:411
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publish_loaned_message";
  ...
  --  
   ...
   function rcl_publisher_assert_liveliness (publisher : access constant rcl_publisher_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:439
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_assert_liveliness";
  ...
  --  
   ...
   function rcl_publisher_wait_for_all_acked (publisher : access constant rcl_publisher_t; timeout : rcl_rcl_time_h.rcl_duration_value_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:478
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_wait_for_all_acked";
  ...
  --  
   ...
   function rcl_publisher_get_topic_name (publisher : access constant rcl_publisher_t) return Interfaces.C.Strings.chars_ptr  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:507
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_get_topic_name";
  ...
  --  
   ...
   function rcl_publisher_get_options (publisher : access constant rcl_publisher_t) return access constant rcl_publisher_options_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:534
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_get_options";
  ...
  --  
   ...
   function rcl_publisher_get_rmw_handle (publisher : access constant rcl_publisher_t) return access rmw_rmw_types_h.rmw_publisher_s  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:565
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_get_rmw_handle";
  ...
  --  
   ...
   function rcl_publisher_get_context (publisher : access constant rcl_publisher_t) return access rcl_rcl_context_h.rcl_context_s  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:593
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_get_context";
  ...
  --  
   ...
   function rcl_publisher_is_valid (publisher : access constant rcl_publisher_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:615
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_is_valid";
  ...
  --  
   ...
   function rcl_publisher_is_valid_except_context (publisher : access constant rcl_publisher_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:628
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_is_valid_except_context";
  ...
  --  
   ...
   function rcl_publisher_get_subscription_count (publisher : access constant rcl_publisher_t; subscription_count : access stddef_h.size_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:653
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_get_subscription_count";
  ...
  --  
   ...
   function rcl_publisher_get_actual_qos (publisher : access constant rcl_publisher_t) return access constant rmw_rmw_types_h.rmw_qos_profile_s  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:681
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_get_actual_qos";
  ...
  --  
   ...
   function rcl_publisher_can_loan_messages (publisher : access constant rcl_publisher_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl/rcl/publisher.h:691
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_publisher_can_loan_messages";

end rcl_rcl_publisher_h;
