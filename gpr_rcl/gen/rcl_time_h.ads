...
package rcl_time_h is
  ...
  --/ A single point in time, measured in nanoseconds since the Unix epoch.
   subtype rcl_time_point_value_t is rcutils_time_h.rcutils_time_point_value_t;  -- /opt/ros/dashing/include/rcl/time.h:44

  --/ A duration of time, measured in nanoseconds.
   subtype rcl_duration_value_t is rcutils_time_h.rcutils_duration_value_t;  -- /opt/ros/dashing/include/rcl/time.h:46
  ...
  --/ Time source type, used to indicate the source of a time measurement.
   type rcl_clock_type_t is 
     (RCL_CLOCK_UNINITIALIZED,
      ...
      RCL_SYSTEM_TIME,
      RCL_STEADY_TIME);
   pragma Convention (C, rcl_clock_type_t);  -- /opt/ros/dashing/include/rcl/time.h:49

  --/ A duration of time, measured in nanoseconds and its source.
   type rcl_duration_t is record
      nanoseconds : aliased rcl_duration_value_t;  -- /opt/ros/dashing/include/rcl/time.h:60
   end record;
   pragma Convention (C_Pass_By_Copy, rcl_duration_t);  -- /opt/ros/dashing/include/rcl/time.h:58
  ...
  --/ Enumeration to describe the type of time jump.
   ...
   RCL_SYSTEM_TIME_NO_CHANGE : constant rcl_clock_change_t := 4;  -- /opt/ros/dashing/include/rcl/time.h:64
  ...
  --/ Indicate whether or not the source of time changed.
   type rcl_time_jump_t is record
      clock_change : aliased rcl_clock_change_t;  -- /opt/ros/dashing/include/rcl/time.h:80
      c_delta : aliased rcl_duration_t;  -- /opt/ros/dashing/include/rcl/time.h:82
   end record;
   pragma Convention (C_Pass_By_Copy, rcl_time_jump_t);  -- /opt/ros/dashing/include/rcl/time.h:77
  ...
  --/ \param[in] user_data A pointer given at callback registration which is passed to the callback.
   type rcl_jump_callback_t is access procedure
        (arg1 : access constant rcl_time_jump_t;
         ...
         arg3 : System.Address);
   pragma Convention (C, rcl_jump_callback_t);  -- /opt/ros/dashing/include/rcl/time.h:90

  --/ Describe the prerequisites for calling a time jump callback.
  --/ True to call callback when the clock type changes.
   type rcl_jump_threshold_t is record
      on_clock_change : aliased Extensions.bool;  -- /opt/ros/dashing/include/rcl/time.h:99
      min_forward : aliased rcl_duration_t;  -- /opt/ros/dashing/include/rcl/time.h:102
      min_backward : aliased rcl_duration_t;  -- /opt/ros/dashing/include/rcl/time.h:105
   end record;
   pragma Convention (C_Pass_By_Copy, rcl_jump_threshold_t);  -- /opt/ros/dashing/include/rcl/time.h:96
  ...
  --/ Struct to describe an added callback.
   type rcl_jump_callback_info_t is record
      callback : rcl_jump_callback_t;  -- /opt/ros/dashing/include/rcl/time.h:111
      threshold : aliased rcl_jump_threshold_t;  -- /opt/ros/dashing/include/rcl/time.h:112
      user_data : System.Address;  -- /opt/ros/dashing/include/rcl/time.h:113
   end record;
   pragma Convention (C_Pass_By_Copy, rcl_jump_callback_info_t);  -- /opt/ros/dashing/include/rcl/time.h:109

  --/ Encapsulation of a time source.
   type rcl_clock_t is record
      c_type : aliased rcl_clock_type_t;  -- /opt/ros/dashing/include/rcl/time.h:119
      jump_callbacks : access rcl_jump_callback_info_t;  -- /opt/ros/dashing/include/rcl/time.h:121
      num_jump_callbacks : aliased stddef_h.size_t;  -- /opt/ros/dashing/include/rcl/time.h:123
      get_now : access function (arg1 : System.Address; arg2 : access rcl_time_point_value_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:124
      data : System.Address;  -- /opt/ros/dashing/include/rcl/time.h:126
      allocator : aliased rcl_allocator_h.rcl_allocator_t;  -- /opt/ros/dashing/include/rcl/time.h:127
   end record;
   pragma Convention (C_Pass_By_Copy, rcl_clock_t);  -- /opt/ros/dashing/include/rcl/time.h:117
  ...
  --/ A single point in time, measured in nanoseconds, the reference point is based on the source.
   type rcl_time_point_t is record
      nanoseconds : aliased rcl_time_point_value_t;  -- /opt/ros/dashing/include/rcl/time.h:133
      clock_type : aliased rcl_clock_type_t;  -- /opt/ros/dashing/include/rcl/time.h:134
   end record;
   pragma Convention (C_Pass_By_Copy, rcl_time_point_t);  -- /opt/ros/dashing/include/rcl/time.h:131
  ...
  --  
   ...
   function rcl_clock_valid (clock : access rcl_clock_t) return Extensions.bool;  -- /opt/ros/dashing/include/rcl/time.h:158
  ...
  --  
   ...
   function rcl_clock_init
     (clock_type : rcl_clock_type_t;
      ...
      allocator : access rcl_allocator_h.rcl_allocator_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:174
  ...
  --  
   ...
   function rcl_clock_fini (clock : access rcl_clock_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:194
  ...
  --  
   ...
   function rcl_ros_clock_init (clock : access rcl_clock_t; allocator : access rcl_allocator_h.rcl_allocator_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:211
  ...
  --  
   ...
   function rcl_ros_clock_fini (clock : access rcl_clock_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:229
  ...
  --  
   ...
   function rcl_steady_clock_init (clock : access rcl_clock_t; allocator : access rcl_allocator_h.rcl_allocator_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:246
  ...
  --  
   ...
   function rcl_steady_clock_fini (clock : access rcl_clock_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:266
  ...
  --  
   ...
   function rcl_system_clock_init (clock : access rcl_clock_t; allocator : access rcl_allocator_h.rcl_allocator_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:285
  ...
  --  
   ...
   function rcl_system_clock_fini (clock : access rcl_clock_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:305
  ...
  --  
   ...
   function rcl_difference_times
     (start : access rcl_time_point_t;
      ...
      c_delta : access rcl_duration_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:327
  ...
  --  
   ...
   function rcl_clock_get_now (clock : access rcl_clock_t; time_point_value : access rcl_time_point_value_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:343
  ...
  --  
   ...
   function rcl_enable_ros_time_override (clock : access rcl_clock_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:360
  ...
  --  
   ...
   function rcl_disable_ros_time_override (clock : access rcl_clock_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:376
  ...
  --  
   ...
   function rcl_is_enabled_ros_time_override (clock : access rcl_clock_t; is_enabled : access Extensions.bool) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:394
  ...
  --  
   ...
   function rcl_set_ros_time_override (clock : access rcl_clock_t; time_value : rcl_time_point_value_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:413
  ...
  --  
   ...
   function rcl_clock_add_jump_callback
     (clock : access rcl_clock_t;
      ...
      user_data : System.Address) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:434
  ...
  --  
   ...
   function rcl_clock_remove_jump_callback
     (clock : access rcl_clock_t;
      callback : rcl_jump_callback_t;
      user_data : System.Address) return rcl_types_h.rcl_ret_t;  -- /opt/ros/dashing/include/rcl/time.h:451
