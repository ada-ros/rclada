...
package rcl_rcl_time_h is
  ...
  --/ A single point in time, measured in nanoseconds since the Unix epoch.
   subtype rcl_time_point_value_t is rcutils_rcutils_time_h.rcutils_time_point_value_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:46

  --/ A duration of time, measured in nanoseconds.
   subtype rcl_duration_value_t is rcutils_rcutils_time_h.rcutils_duration_value_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:48
  ...
  --  
   ...
   type rcl_clock_type_e is 
     (RCL_CLOCK_UNINITIALIZED,
      RCL_ROS_TIME,
      RCL_SYSTEM_TIME,
      RCL_STEADY_TIME)
   with Convention => C;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:61

  --/ Clock uninitialized
  --/ Use ROS time
  --/ Use system time
  --/ Use a steady clock time
   subtype rcl_clock_type_t is rcl_clock_type_e;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:71

  --/ A duration of time, measured in nanoseconds and its source.
  --/ Duration in nanoseconds and its source.
   type rcl_duration_s is record
      nanoseconds : aliased rcl_duration_value_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:77
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:74

   subtype rcl_duration_t is rcl_duration_s;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:78

  --/ Enumeration to describe the type of time jump.
   subtype rcl_clock_change_e is unsigned;
   rcl_clock_change_e_RCL_ROS_TIME_NO_CHANGE : constant rcl_clock_change_e := 1;
   rcl_clock_change_e_RCL_ROS_TIME_ACTIVATED : constant rcl_clock_change_e := 2;
   rcl_clock_change_e_RCL_ROS_TIME_DEACTIVATED : constant rcl_clock_change_e := 3;
   rcl_clock_change_e_RCL_SYSTEM_TIME_NO_CHANGE : constant rcl_clock_change_e := 4;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:81

  --/ The source before and after the jump is ROS_TIME.
  --/ The source switched to ROS_TIME from SYSTEM_TIME.
  --/ The source switched to SYSTEM_TIME from ROS_TIME.
  --/ The source before and after the jump is SYSTEM_TIME.
   subtype rcl_clock_change_t is rcl_clock_change_e;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:91

  --/ Struct to describe a jump in time.
  --/ Indicate whether or not the source of time changed.
   type rcl_time_jump_s is record
      clock_change : aliased rcl_clock_change_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:97
      c_delta : aliased rcl_duration_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:99
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:94

  --/ The new time minus the last time before the jump.
   subtype rcl_time_jump_t is rcl_time_jump_s;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:100
  ...
  --/ \param[in] user_data A pointer given at callback registration which is passed to the callback.
   type rcl_jump_callback_t is access procedure
        (arg1 : access constant rcl_time_jump_t;
         ...
         arg3 : System.Address)
   with Convention => C;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:107

  --/ Describe the prerequisites for calling a time jump callback.
  --/ True to call callback when the clock type changes.
   type rcl_jump_threshold_s is record
      on_clock_change : aliased Extensions.bool;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:116
      min_forward : aliased rcl_duration_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:119
      min_backward : aliased rcl_duration_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:122
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:113
  ...
  --/ to disable.
   subtype rcl_jump_threshold_t is rcl_jump_threshold_s;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:123

  --/ Struct to describe an added callback.
  --/ Callback to fucntion.
   type rcl_jump_callback_info_s is record
      callback : rcl_jump_callback_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:129
      threshold : aliased rcl_jump_threshold_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:131
      user_data : System.Address;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:133
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:126

  --/ Threshold to decide when to call the callback.
  --/ Pointer passed to the callback.
   subtype rcl_jump_callback_info_t is rcl_jump_callback_info_s;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:134

  --/ Encapsulation of a time source.
  --/ Clock type
   type rcl_clock_s is record
      c_type : aliased rcl_clock_type_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:140
      jump_callbacks : access rcl_jump_callback_info_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:142
      num_jump_callbacks : aliased stddef_h.size_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:144
      get_now : access function (arg1 : System.Address; arg2 : access rcl_time_point_value_t) return rcl_rcl_types_h.rcl_ret_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:146
      data : System.Address;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:149
      allocator : aliased rcl_rcl_allocator_h.rcl_allocator_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:151
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:137
  ...
  --/ Custom allocator used for internal allocations.
   subtype rcl_clock_t is rcl_clock_s;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:152

  --/ A single point in time, measured in nanoseconds, the reference point is based on the source.
  --/ Nanoseconds of the point in time
   type rcl_time_point_s is record
      nanoseconds : aliased rcl_time_point_value_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:158
      clock_type : aliased rcl_clock_type_t;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:160
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:155

  --/ Clock type of the point in time
   subtype rcl_time_point_t is rcl_time_point_s;  -- /opt/ros/jazzy/include/rcl/rcl/time.h:161
  ...
  --  
   ...
   function rcl_clock_time_started (clock : access rcl_clock_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl/rcl/time.h:195
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_clock_time_started";
  ...
  --  
   ...
   function rcl_clock_valid (clock : access rcl_clock_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl/rcl/time.h:218
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_clock_init
     (clock_type : rcl_clock_type_t;
      ...
      allocator : access rcutils_rcutils_allocator_h.rcutils_allocator_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:246
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_clock_fini (clock : access rcl_clock_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:281
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_ros_clock_init (clock : access rcl_clock_t; allocator : access rcutils_rcutils_allocator_h.rcutils_allocator_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:310
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_ros_clock_fini (clock : access rcl_clock_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:343
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_steady_clock_init (clock : access rcl_clock_t; allocator : access rcutils_rcutils_allocator_h.rcutils_allocator_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:371
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_steady_clock_fini (clock : access rcl_clock_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:406
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_system_clock_init (clock : access rcl_clock_t; allocator : access rcutils_rcutils_allocator_h.rcutils_allocator_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:437
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_system_clock_fini (clock : access rcl_clock_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:471
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_difference_times
     (start : access constant rcl_time_point_t;
      finish : access constant rcl_time_point_t;
      c_delta : access rcl_duration_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:501
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_clock_get_now (clock : access rcl_clock_t; time_point_value : access rcl_time_point_value_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:528
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_enable_ros_time_override (clock : access rcl_clock_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:560
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_disable_ros_time_override (clock : access rcl_clock_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:591
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_is_enabled_ros_time_override (clock : access rcl_clock_t; is_enabled : access Extensions.bool) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:622
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_set_ros_time_override (clock : access rcl_clock_t; time_value : rcl_time_point_value_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:656
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_clock_add_jump_callback
     (clock : access rcl_clock_t;
      ...
      user_data : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:694
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_clock_remove_jump_callback
     (clock : access rcl_clock_t;
      callback : rcl_jump_callback_t;
      user_data : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/time.h:727
   with Import => True, 
        Convention => C, 
