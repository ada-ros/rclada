...
package rcutils_rcutils_types_uint8_array_h is
  ...
  --/ The allocated memory for the uint8 array.
   type rcutils_uint8_array_s is record
      buffer : access x86_64_linux_gnu_bits_stdint_uintn_h.uint8_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/uint8_array.h:35
      buffer_length : aliased stddef_h.size_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/uint8_array.h:38
      buffer_capacity : aliased stddef_h.size_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/uint8_array.h:41
      allocator : aliased rcutils_rcutils_allocator_h.rcutils_allocator_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/uint8_array.h:44
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/uint8_array.h:32
  ...
  --/ The allocator used to allocate and free memory for the uint8 array.
   subtype rcutils_uint8_array_t is rcutils_uint8_array_s;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/uint8_array.h:45
  ...
  --  
   ...
   function rcutils_get_zero_initialized_uint8_array return rcutils_uint8_array_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/uint8_array.h:54
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_uint8_array_init
     (uint8_array : access rcutils_uint8_array_t;
      ...
      allocator : access constant rcutils_rcutils_allocator_h.rcutils_allocator_s) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/uint8_array.h:73
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_uint8_array_fini (uint8_array : access rcutils_uint8_array_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/uint8_array.h:94
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_uint8_array_resize (uint8_array : access rcutils_uint8_array_t; new_size : stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/uint8_array.h:115
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_uint8_array_resize";

end rcutils_rcutils_types_uint8_array_h;
