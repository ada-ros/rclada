...
package rcl_rcl_init_h is
  ...
  --  
   ...
   function rcl_init
     (argc : int;
      argv : System.Address;
      options : access constant rcl_rcl_init_options_h.rcl_init_options_s;
      context : access rcl_rcl_context_h.rcl_context_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/init.h:81
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_shutdown (context : access rcl_rcl_context_h.rcl_context_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/init.h:115
   with Import => True, 
        Convention => C, 
