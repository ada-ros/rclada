...
limited with rcl_rcl_init_options_h;
with stddef_h;
with Interfaces.C.Extensions;
limited with rmw_rmw_init_h;

package rcl_rcl_context_h is
  ...
  --/ A unique ID per context instance.
   subtype rcl_context_instance_id_t is x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t;  -- /opt/ros/jazzy/include/rcl/rcl/context.h:44

   type rcl_context_impl_s is null record;   -- incomplete struct

   subtype rcl_context_impl_t is rcl_context_impl_s;  -- /opt/ros/jazzy/include/rcl/rcl/context.h:46
  ...
  --* Typically generated by the parsing of argc/argv in rcl_init().  
   type anon_array3048 is array (0 .. 7) of aliased x86_64_linux_gnu_bits_stdint_uintn_h.uint8_t;
   type rcl_context_s is record
      global_arguments : aliased rcl_rcl_arguments_h.rcl_arguments_t;  -- /opt/ros/jazzy/include/rcl/rcl/context.h:117
      impl : access rcl_context_impl_t;  -- /opt/ros/jazzy/include/rcl/rcl/context.h:120
      instance_id_storage : aliased anon_array3048;  -- /opt/ros/jazzy/include/rcl/rcl/context.h:149
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/context.h:113
  ...
  --    
   ...
   subtype rcl_context_t is rcl_context_s;  -- /opt/ros/jazzy/include/rcl/rcl/context.h:150

  --/ Return a zero initialization context object.
   function rcl_get_zero_initialized_context return rcl_context_t  -- /opt/ros/jazzy/include/rcl/rcl/context.h:156
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_get_zero_initialized_context";
  ...
  --  
   ...
   function rcl_context_fini (context : access rcl_context_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/context.h:185
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_context_get_init_options (context : access constant rcl_context_t) return access constant rcl_rcl_init_options_h.rcl_init_options_s  -- /opt/ros/jazzy/include/rcl/rcl/context.h:217
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_context_get_instance_id (context : access constant rcl_context_t) return rcl_context_instance_id_t  -- /opt/ros/jazzy/include/rcl/rcl/context.h:245
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_context_get_domain_id (context : access rcl_context_t; domain_id : access stddef_h.size_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/context.h:271
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_context_get_domain_id";
  ...
  --  
   ...
   function rcl_context_is_valid (context : access constant rcl_context_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl/rcl/context.h:293
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_context_get_rmw_context (context : access rcl_context_t) return access rmw_rmw_init_h.rmw_context_s  -- /opt/ros/jazzy/include/rcl/rcl/context.h:315
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_context_get_rmw_context";

end rcl_rcl_context_h;
