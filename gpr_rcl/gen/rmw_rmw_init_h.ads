...
with rmw_rmw_init_options_h;
with stddef_h;
with rmw_rmw_ret_types_h;

package rmw_rmw_init_h is
  ...
  --  
   ...
   type rmw_context_impl_s is null record;   -- incomplete struct

   subtype rmw_context_impl_t is rmw_context_impl_s;  -- /opt/ros/jazzy/include/rmw/rmw/init.h:34

  --/ Initialization context structure which is used to store init specific information.
  --/ Locally (process local) unique ID that represents this init/shutdown cycle.
   type rmw_context_s is record
      instance_id : aliased x86_64_linux_gnu_bits_stdint_uintn_h.uint64_t;  -- /opt/ros/jazzy/include/rmw/rmw/init.h:40
      implementation_identifier : Interfaces.C.Strings.chars_ptr;  -- /opt/ros/jazzy/include/rmw/rmw/init.h:42
      options : aliased rmw_rmw_init_options_h.rmw_init_options_t;  -- /opt/ros/jazzy/include/rmw/rmw/init.h:44
      actual_domain_id : aliased stddef_h.size_t;  -- /opt/ros/jazzy/include/rmw/rmw/init.h:46
      impl : access rmw_context_impl_t;  -- /opt/ros/jazzy/include/rmw/rmw/init.h:49
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rmw/rmw/init.h:37
  ...
  --* May be NULL if there is no implementation defined context information.  
   subtype rmw_context_t is rmw_context_s;  -- /opt/ros/jazzy/include/rmw/rmw/init.h:50

  --/ Return a zero initialized context structure.
   function rmw_get_zero_initialized_context return rmw_context_t  -- /opt/ros/jazzy/include/rmw/rmw/init.h:56
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rmw_init (options : access constant rmw_rmw_init_options_h.rmw_init_options_s; context : access rmw_context_t) return rmw_rmw_ret_types_h.rmw_ret_t  -- /opt/ros/jazzy/include/rmw/rmw/init.h:101
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rmw_shutdown (context : access rmw_context_t) return rmw_rmw_ret_types_h.rmw_ret_t  -- /opt/ros/jazzy/include/rmw/rmw/init.h:131
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rmw_context_fini (context : access rmw_context_t) return rmw_rmw_ret_types_h.rmw_ret_t  -- /opt/ros/jazzy/include/rmw/rmw/init.h:167
   with Import => True, 
        Convention => C, 
