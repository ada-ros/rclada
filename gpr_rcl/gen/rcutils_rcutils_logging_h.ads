...
with System;
limited with rcutils_rcutils_types_char_array_h;

package rcutils_rcutils_logging_h is

   RCUTILS_LOGGING_SEPARATOR_STRING : aliased constant String := "." & ASCII.NUL;  --  /opt/ros/jazzy/include/rcutils/rcutils/logging.h:37
   --  unsupported macro: RCUTILS_DEFAULT_LOGGER_DEFAULT_LEVEL RCUTILS_LOG_SEVERITY_INFO
   --  unsupported macro: RCUTILS_LOGGING_AUTOINIT RCUTILS_LOGGING_AUTOINIT_WITH_ALLOCATOR(rcutils_get_default_allocator())
   --  arg-macro: procedure RCUTILS_LOGGING_AUTOINIT_WITH_ALLOCATOR (alloc)
   --    do { if (RCUTILS_UNLIKELY(notg_rcutils_logging_initialized)) { if (rcutils_logging_initialize_with_allocator(alloc) /= RCUTILS_RET_OK) { RCUTILS_SAFE_FWRITE_TO_STDERR( "[rcutils|" __FILE__ & ":" RCUTILS_STRINGIFY(__LINE__) & "] error initializing logging: "); RCUTILS_SAFE_FWRITE_TO_STDERR(rcutils_get_error_string().str); RCUTILS_SAFE_FWRITE_TO_STDERR(& "" & ASCII.LF & ""); rcutils_reset_error(); } } } while (0)
  ...
  --/ The flag if the logging system has been initialized.
   g_rcutils_logging_initialized : aliased Extensions.bool  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:47
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_initialize_with_allocator (allocator : rcutils_rcutils_allocator_h.rcutils_allocator_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:107
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_initialize return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:132
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_shutdown return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:153
   with Import => True, 
        Convention => C, 
  ...
  --/ The name of the function containing the log call.
   type rcutils_log_location_s is record
      function_name : Interfaces.C.Strings.chars_ptr;  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:159
      file_name : Interfaces.C.Strings.chars_ptr;  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:161
      line_number : aliased stddef_h.size_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:163
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:156

  --/ The name of the source file containing the log call.
  --/ The line number containing the log call.
   subtype rcutils_log_location_t is rcutils_log_location_s;  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:164
  ...
  --  
   ...
   RCUTILS_LOG_SEVERITY_RCUTILS_LOG_SEVERITY_UNSET : constant RCUTILS_LOG_SEVERITY := 0;
   RCUTILS_LOG_SEVERITY_RCUTILS_LOG_SEVERITY_DEBUG : constant RCUTILS_LOG_SEVERITY := 10;
   RCUTILS_LOG_SEVERITY_RCUTILS_LOG_SEVERITY_INFO : constant RCUTILS_LOG_SEVERITY := 20;
   RCUTILS_LOG_SEVERITY_RCUTILS_LOG_SEVERITY_WARN : constant RCUTILS_LOG_SEVERITY := 30;
   RCUTILS_LOG_SEVERITY_RCUTILS_LOG_SEVERITY_ERROR : constant RCUTILS_LOG_SEVERITY := 40;
   RCUTILS_LOG_SEVERITY_RCUTILS_LOG_SEVERITY_FATAL : constant RCUTILS_LOG_SEVERITY := 50;  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:171
  ...
  --/ The names of severity levels.
   g_rcutils_log_severity_names : array (0 .. 50) of Interfaces.C.Strings.chars_ptr  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:183
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_severity_level_from_string
     (severity_string : Interfaces.C.Strings.chars_ptr;
      ...
      severity : access int) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:205
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   type rcutils_logging_output_handler_t is access procedure
        (arg1 : access constant rcutils_log_location_t;
         ...
         arg4 : rcutils_rcutils_time_h.rcutils_time_point_value_t;
         arg5 : Interfaces.C.Strings.chars_ptr;
         arg6 : access System.Address)
   with Convention => C;  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:217
  ...
  --  
   ...
   function rcutils_logging_get_output_handler return rcutils_logging_output_handler_t  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:240
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure rcutils_logging_set_output_handler (c_function : rcutils_logging_output_handler_t)  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:255
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_format_message
     (location : access constant rcutils_log_location_t;
      ...
      timestamp : rcutils_rcutils_time_h.rcutils_time_point_value_t;
      msg : Interfaces.C.Strings.chars_ptr;
      logging_output : access rcutils_rcutils_types_char_array_h.rcutils_char_array_s) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:281
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_get_default_logger_level return int  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:300
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure rcutils_logging_set_default_logger_level (level : int)  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:319
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_get_logger_level (name : Interfaces.C.Strings.chars_ptr) return int  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:344
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_get_logger_leveln (name : Interfaces.C.Strings.chars_ptr; name_length : stddef_h.size_t) return int  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:369
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_set_logger_level (name : Interfaces.C.Strings.chars_ptr; level : int) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:392
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_logger_is_enabled_for (name : Interfaces.C.Strings.chars_ptr; severity : int) return Extensions.bool  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:412
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_logging_get_logger_effective_level (name : Interfaces.C.Strings.chars_ptr) return int  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:441
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure rcutils_log_internal
     (location : access constant rcutils_log_location_t;
      severity : int;
      name : Interfaces.C.Strings.chars_ptr;
      format : Interfaces.C.Strings.chars_ptr  -- , ...
      )  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:469
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_log_internal";
  ...
  --  
   ...
   procedure rcutils_log
     (location : access constant rcutils_log_location_t;
      ...
      name : Interfaces.C.Strings.chars_ptr;
      format : Interfaces.C.Strings.chars_ptr  -- , ...
      )  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:511
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure rcutils_logging_console_output_handler
     (location : access constant rcutils_log_location_t;
      ...
      timestamp : rcutils_rcutils_time_h.rcutils_time_point_value_t;
      format : Interfaces.C.Strings.chars_ptr;
      args : access System.Address)  -- /opt/ros/jazzy/include/rcutils/rcutils/logging.h:549
   with Import => True, 
        Convention => C, 
