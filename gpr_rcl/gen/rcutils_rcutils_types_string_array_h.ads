...
package rcutils_rcutils_types_string_array_h is
  ...
  --/ The number of strings that can be stored in the string array.
   type rcutils_string_array_s is record
      size : aliased stddef_h.size_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:38
      data : System.Address;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:41
      allocator : aliased rcutils_rcutils_allocator_h.rcutils_allocator_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:44
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:35

  --/ The allocated memory for the string array.
  --/ The allocator used to allocate and free memory for the string array.
   subtype rcutils_string_array_t is rcutils_string_array_s;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:45
  ...
  --  
   ...
   function rcutils_get_zero_initialized_string_array return rcutils_string_array_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:67
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_string_array_init
     (string_array : access rcutils_string_array_t;
      ...
      allocator : access constant rcutils_rcutils_allocator_h.rcutils_allocator_s) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:101
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_string_array_fini (string_array : access rcutils_string_array_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:122
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_string_array_cmp
     (lhs : access constant rcutils_string_array_t;
      ...
      res : access int) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:141
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_string_array_resize (string_array : access rcutils_string_array_t; new_size : stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:171
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_string_array_sort_compare (lhs : System.Address; rhs : System.Address) return int  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:189
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_string_array_sort (string_array : access rcutils_string_array_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_array.h:205
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_array_sort";

end rcutils_rcutils_types_string_array_h;
