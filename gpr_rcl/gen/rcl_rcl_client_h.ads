...
package rcl_rcl_client_h is
  ...
  --/ Internal rcl client implementation struct.
   type rcl_client_impl_s is null record;   -- incomplete struct

   subtype rcl_client_impl_t is rcl_client_impl_s;  -- /opt/ros/jazzy/include/rcl/rcl/client.h:39

  --/ Structure which encapsulates a ROS Client.
  --/ Pointer to the client implementation
   type rcl_client_s is record
      impl : access rcl_client_impl_t;  -- /opt/ros/jazzy/include/rcl/rcl/client.h:45
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/client.h:42

   subtype rcl_client_t is rcl_client_s;  -- /opt/ros/jazzy/include/rcl/rcl/client.h:46

  --/ Options available for a rcl_client_t.
  --/ Middleware quality of service settings for the client.
   type rcl_client_options_s is record
      qos : aliased rmw_rmw_types_h.rmw_qos_profile_t;  -- /opt/ros/jazzy/include/rcl/rcl/client.h:52
      allocator : aliased rcl_rcl_allocator_h.rcl_allocator_t;  -- /opt/ros/jazzy/include/rcl/rcl/client.h:55
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/client.h:49
  ...
  --* For default behavior (malloc/free), use: rcl_get_default_allocator()  
   subtype rcl_client_options_t is rcl_client_options_s;  -- /opt/ros/jazzy/include/rcl/rcl/client.h:56
  ...
  --  
   ...
   function rcl_get_zero_initialized_client return rcl_client_t  -- /opt/ros/jazzy/include/rcl/rcl/client.h:66
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_client_init
     (client : access rcl_client_t;
      ...
      options : access constant rcl_client_options_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/client.h:165
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_client_fini (client : access rcl_client_t; node : access rcl_rcl_node_h.rcl_node_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/client.h:196
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_client_get_default_options return rcl_client_options_t  -- /opt/ros/jazzy/include/rcl/rcl/client.h:208
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_send_request
     (client : access constant rcl_client_t;
      ...
      sequence_number : access x86_64_linux_gnu_bits_stdint_intn_h.int64_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/client.h:257
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_take_response_with_info
     (client : access constant rcl_client_t;
      ...
      ros_response : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/client.h:298
   with Import => True, 
        Convention => C, 
  ...
  --/ backwards compatibility function that takes a rmw_request_id_t only
   function rcl_take_response
     (client : access constant rcl_client_t;
      ...
      ros_response : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/client.h:307
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_client_get_service_name (client : access constant rcl_client_t) return Interfaces.C.Strings.chars_ptr  -- /opt/ros/jazzy/include/rcl/rcl/client.h:337
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_client_get_options (client : access constant rcl_client_t) return access constant rcl_client_options_t  -- /opt/ros/jazzy/include/rcl/rcl/client.h:364
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_client_get_rmw_handle (client : access constant rcl_client_t) return access rmw_rmw_types_h.rmw_client_s  -- /opt/ros/jazzy/include/rcl/rcl/client.h:395
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_client_is_valid (client : access constant rcl_client_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl/rcl/client.h:417
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_client_request_publisher_get_actual_qos (client : access constant rcl_client_t) return access constant rmw_rmw_types_h.rmw_qos_profile_s  -- /opt/ros/jazzy/include/rcl/rcl/client.h:443
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_client_request_publisher_get_actual_qos";
  ...
  --  
   ...
   function rcl_client_response_subscription_get_actual_qos (client : access constant rcl_client_t) return access constant rmw_rmw_types_h.rmw_qos_profile_s  -- /opt/ros/jazzy/include/rcl/rcl/client.h:469
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_client_response_subscription_get_actual_qos";
  ...
  --  
   ...
   function rcl_client_set_on_new_response_callback
     (client : access constant rcl_client_t;
      ...
      user_data : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/client.h:497
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_client_set_on_new_response_callback";
  ...
  --  
   ...
   function rcl_client_configure_service_introspection
     (client : access rcl_client_t;
      ...
      introspection_state : rcl_rcl_service_introspection_h.rcl_service_introspection_state_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/client.h:535
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_client_configure_service_introspection";

end rcl_rcl_client_h;
