...
with rcutils_rcutils_types_uint8_array_h;

package rmw_rmw_serialized_message_h is

   --  unsupported macro: rmw_get_zero_initialized_serialized_message rcutils_get_zero_initialized_uint8_array
   --  arg-macro: procedure rmw_serialized_message_init (serialized_message, message_capacity, allocator)
   --    rcutils_uint8_array_init(serialized_message, message_capacity, allocator)
   --  arg-macro: procedure rmw_serialized_message_fini (serialized_message)
   --    rcutils_uint8_array_fini(serialized_message)
   --  arg-macro: procedure rmw_serialized_message_resize (serialized_message, new_size)
  ...
  --  
   ...
   subtype rmw_serialized_message_t is rcutils_rcutils_types_uint8_array_h.rcutils_uint8_array_t;  -- /opt/ros/jazzy/include/rmw/rmw/serialized_message.h:37
...
end rmw_rmw_serialized_message_h;
