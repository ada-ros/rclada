...
package rmw_rmw_names_and_types_h is
  ...
  --/ Array of names
   type rmw_names_and_types_s is record
      names : aliased rcutils_rcutils_types_string_array_h.rcutils_string_array_t;  -- /opt/ros/jazzy/include/rmw/rmw/names_and_types.h:35
      types : access rcutils_rcutils_types_string_array_h.rcutils_string_array_s;  -- /opt/ros/jazzy/include/rmw/rmw/names_and_types.h:38
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rmw/rmw/names_and_types.h:32

  --/ Dynamic array of arrays of type names, with the same length as `names`
   subtype rmw_names_and_types_t is rmw_names_and_types_s;  -- /opt/ros/jazzy/include/rmw/rmw/names_and_types.h:39

  --/ Return a zero initialized array of names and types.
   function rmw_get_zero_initialized_names_and_types return rmw_names_and_types_t  -- /opt/ros/jazzy/include/rmw/rmw/names_and_types.h:45
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rmw_names_and_types_check_zero (names_and_types : access rmw_names_and_types_t) return rmw_rmw_ret_types_h.rmw_ret_t  -- /opt/ros/jazzy/include/rmw/rmw/names_and_types.h:68
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rmw_names_and_types_init
     (names_and_types : access rmw_names_and_types_t;
      ...
      allocator : access rcutils_rcutils_allocator_h.rcutils_allocator_s) return rmw_rmw_ret_types_h.rmw_ret_t  -- /opt/ros/jazzy/include/rmw/rmw/names_and_types.h:109
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rmw_names_and_types_fini (names_and_types : access rmw_names_and_types_t) return rmw_rmw_ret_types_h.rmw_ret_t  -- /opt/ros/jazzy/include/rmw/rmw/names_and_types.h:144
   with Import => True, 
        Convention => C, 
        External_Name => "rmw_names_and_types_fini";

end rmw_rmw_names_and_types_h;
