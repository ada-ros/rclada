...
package rcutils_rcutils_types_char_array_h is
  ...
  --/ A pointer to the allocated memory for this char array.
   type rcutils_char_array_s is record
      buffer : Interfaces.C.Strings.chars_ptr;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:35
      owns_buffer : aliased Extensions.bool;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:42
      buffer_length : aliased stddef_h.size_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:45
      buffer_capacity : aliased stddef_h.size_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:48
      allocator : aliased rcutils_rcutils_allocator_h.rcutils_allocator_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:51
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:32
  ...
  --/ The allocator used to allocate and free the data in the pointer.
   subtype rcutils_char_array_t is rcutils_char_array_s;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:52
  ...
  --  
   ...
   function rcutils_get_zero_initialized_char_array return rcutils_char_array_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:61
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_char_array_init
     (char_array : access rcutils_char_array_t;
      ...
      allocator : access constant rcutils_rcutils_allocator_h.rcutils_allocator_s) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:81
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_char_array_fini (char_array : access rcutils_char_array_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:104
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_char_array_resize (char_array : access rcutils_char_array_t; new_size : stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:129
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_char_array_expand_as_needed (char_array : access rcutils_char_array_t; new_size : stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:147
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_char_array_vsprintf
     (char_array : access rcutils_char_array_t;
      ...
      args : access System.Address) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:168
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_char_array_strncat
     (char_array : access rcutils_char_array_t;
      ...
      n : stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:187
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_char_array_strcat (char_array : access rcutils_char_array_t; src : Interfaces.C.Strings.chars_ptr) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:206
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_char_array_memcpy
     (char_array : access rcutils_char_array_t;
      src : Interfaces.C.Strings.chars_ptr;
      n : stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:223
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_char_array_strcpy (char_array : access rcutils_char_array_t; src : Interfaces.C.Strings.chars_ptr) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/char_array.h:240
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_char_array_strcpy";

end rcutils_rcutils_types_char_array_h;
