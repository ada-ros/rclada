...
with stddef_h;
limited with rmw_rmw_topic_endpoint_info_h;
with rmw_rmw_ret_types_h;
limited with rcutils_rcutils_allocator_h;

package rmw_rmw_topic_endpoint_info_array_h is
  ...
  --/ Size of the array.
   type rmw_topic_endpoint_info_array_s is record
      size : aliased stddef_h.size_t;  -- /opt/ros/jazzy/include/rmw/rmw/topic_endpoint_info_array.h:31
      info_array : access rmw_rmw_topic_endpoint_info_h.rmw_topic_endpoint_info_s;  -- /opt/ros/jazzy/include/rmw/rmw/topic_endpoint_info_array.h:33
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rmw/rmw/topic_endpoint_info_array.h:28

  --/ Contiguous storage for topic endpoint information elements.
   subtype rmw_topic_endpoint_info_array_t is rmw_topic_endpoint_info_array_s;  -- /opt/ros/jazzy/include/rmw/rmw/topic_endpoint_info_array.h:34

  --/ Return a zero initialized array of topic endpoint information.
   function rmw_get_zero_initialized_topic_endpoint_info_array return rmw_topic_endpoint_info_array_t  -- /opt/ros/jazzy/include/rmw/rmw/topic_endpoint_info_array.h:40
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rmw_topic_endpoint_info_array_check_zero (topic_endpoint_info_array : access rmw_topic_endpoint_info_array_t) return rmw_rmw_ret_types_h.rmw_ret_t  -- /opt/ros/jazzy/include/rmw/rmw/topic_endpoint_info_array.h:66
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rmw_topic_endpoint_info_array_init_with_size
     (topic_endpoint_info_array : access rmw_topic_endpoint_info_array_t;
      ...
      allocator : access rcutils_rcutils_allocator_h.rcutils_allocator_s) return rmw_rmw_ret_types_h.rmw_ret_t  -- /opt/ros/jazzy/include/rmw/rmw/topic_endpoint_info_array.h:106
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rmw_topic_endpoint_info_array_fini (topic_endpoint_info_array : access rmw_topic_endpoint_info_array_t; allocator : access rcutils_rcutils_allocator_h.rcutils_allocator_s) return rmw_rmw_ret_types_h.rmw_ret_t  -- /opt/ros/jazzy/include/rmw/rmw/topic_endpoint_info_array.h:147
   with Import => True, 
        Convention => C, 
        External_Name => "rmw_topic_endpoint_info_array_fini";

end rmw_rmw_topic_endpoint_info_array_h;
