...
with action_msgs_action_msgs_msg_detail_goal_status_array_ustruct_h;
with rcl_rcl_allocator_h;
with action_msgs_action_msgs_srv_detail_cancel_goal_ustruct_h;
with x86_64_linux_gnu_bits_stdint_intn_h;
with Interfaces.C.Strings;
with stddef_h;
with rcl_rcl_types_h;

package rcl_action_rcl_action_types_h is

   RCL_RET_ACTION_NAME_INVALID : constant := 2000;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:38

   RCL_RET_ACTION_GOAL_ACCEPTED : constant := 2100;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:40

   RCL_RET_ACTION_GOAL_REJECTED : constant := 2101;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:42

   RCL_RET_ACTION_CLIENT_INVALID : constant := 2102;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:44

   RCL_RET_ACTION_CLIENT_TAKE_FAILED : constant := 2103;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:46

   RCL_RET_ACTION_SERVER_INVALID : constant := 2200;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:48

   RCL_RET_ACTION_SERVER_TAKE_FAILED : constant := 2201;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:50

   RCL_RET_ACTION_GOAL_HANDLE_INVALID : constant := 2300;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:52

   RCL_RET_ACTION_GOAL_EVENT_INVALID : constant := 2301;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:54

   UUID_SIZE : constant := 16;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:57
   ...
   GOAL_STATE_NUM_STATES : constant := 7;  --  /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:95
  ...
  -- Typedef generated messages for convenience
   subtype rcl_action_goal_info_t is action_msgs_action_msgs_msg_detail_goal_info_ustruct_h.action_msgs_u_msg_u_GoalInfo;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:63

   subtype rcl_action_goal_status_t is action_msgs_action_msgs_msg_detail_goal_status_ustruct_h.action_msgs_u_msg_u_GoalStatus;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:64

  --/ Struct with the action goal status array
  --/ Goal status array message
   type rcl_action_goal_status_array_s is record
      msg : aliased action_msgs_action_msgs_msg_detail_goal_status_array_ustruct_h.action_msgs_u_msg_u_GoalStatusArray;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:69
      allocator : aliased rcl_rcl_allocator_h.rcl_allocator_t;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:71
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:66

  --/ Allocator used to initialize this struct.
   subtype rcl_action_goal_status_array_t is rcl_action_goal_status_array_s;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:72

   subtype rcl_action_cancel_request_t is action_msgs_action_msgs_srv_detail_cancel_goal_ustruct_h.action_msgs_u_srv_u_CancelGoal_Request;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:73

  --/ Struct with the action cancel response
  --/ Cancel goal response message
   type rcl_action_cancel_response_s is record
      msg : aliased action_msgs_action_msgs_srv_detail_cancel_goal_ustruct_h.action_msgs_u_srv_u_CancelGoal_Response;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:78
      allocator : aliased rcl_rcl_allocator_h.rcl_allocator_t;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:80
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:75

  --/ Allocator used to initialize this struct.
   subtype rcl_action_cancel_response_t is rcl_action_cancel_response_s;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:81
  ...
  -- is available. Issue: https://github.com/ros2/rosidl/issues/260
   subtype rcl_action_goal_state_t is x86_64_linux_gnu_bits_stdint_intn_h.int8_t;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:87
  ...
  -- Description variables in types.c should be changed if enum values change
   goal_state_descriptions : array (size_t) of Interfaces.C.Strings.chars_ptr  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:99
   with Import => True, 
        Convention => C, 
        External_Name => "goal_state_descriptions";

   goal_event_descriptions : array (size_t) of Interfaces.C.Strings.chars_ptr  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:100
   with Import => True, 
        Convention => C, 
        External_Name => "goal_event_descriptions";

  --/ Goal state transition events
   type rcl_action_goal_event_e is 
     (GOAL_EVENT_EXECUTE,
   ...
   with Convention => C;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:103

   subtype rcl_action_goal_event_t is rcl_action_goal_event_e;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:111

  --/ Return a rcl_action_goal_info_t with members set to zero values.
   function rcl_action_get_zero_initialized_goal_info return rcl_action_goal_info_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:117
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_get_zero_initialized_goal_status_array return rcl_action_goal_status_array_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:127
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_get_zero_initialized_cancel_request return rcl_action_cancel_request_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:138
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_get_zero_initialized_cancel_response return rcl_action_cancel_response_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:148
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_goal_status_array_init
     (status_array : access rcl_action_goal_status_array_t;
      ...
      allocator : rcl_rcl_allocator_h.rcl_allocator_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:196
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_goal_status_array_fini (status_array : access rcl_action_goal_status_array_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:221
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_cancel_response_init
     (cancel_response : access rcl_action_cancel_response_t;
      ...
      allocator : rcl_rcl_allocator_h.rcl_allocator_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:269
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_cancel_response_fini (cancel_response : access rcl_action_cancel_response_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/types.h:294
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_action_cancel_response_fini";

end rcl_action_rcl_action_types_h;
