...
package rcl_expand_topic_name_h is
  ...
  --  
   ...
   function rcl_expand_topic_name
     (input_topic_name : Interfaces.C.Strings.chars_ptr;
      ...
      output_topic_name : System.Address) return rcl_types_h.rcl_ret_t;  -- /opt/ros/crystal/include/rcl/expand_topic_name.h:117
  ...
  --  
   ...
   function rcl_get_default_topic_name_substitutions (string_map : access rcutils_types_string_map_h.rcutils_string_map_t) return rcl_types_h.rcl_ret_t;  -- /opt/ros/crystal/include/rcl/expand_topic_name.h:138
