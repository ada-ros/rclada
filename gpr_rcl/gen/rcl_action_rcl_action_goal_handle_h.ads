...
with rcl_action_rcl_action_types_h;
with Interfaces.C.Extensions;

package rcl_action_rcl_action_goal_handle_h is
  ...
  --/ Internal rcl action goal implementation struct.
   type rcl_action_goal_handle_impl_s is null record;   -- incomplete struct

   subtype rcl_action_goal_handle_impl_t is rcl_action_goal_handle_impl_s;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:30

  --/ Goal handle for an action.
  --/ Pointer to the action goal handle implementation
   type rcl_action_goal_handle_s is record
      impl : access rcl_action_goal_handle_impl_t;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:36
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:33

   subtype rcl_action_goal_handle_t is rcl_action_goal_handle_s;  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:37
  ...
  --  
   ...
   function rcl_action_get_zero_initialized_goal_handle return rcl_action_goal_handle_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:47
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_goal_handle_init
     (goal_handle : access rcl_action_goal_handle_t;
      goal_info : access constant action_msgs_action_msgs_msg_detail_goal_info_ustruct_h.action_msgs_u_msg_u_GoalInfo;
      allocator : rcl_rcl_allocator_h.rcl_allocator_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:84
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_goal_handle_fini (goal_handle : access rcl_action_goal_handle_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:116
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_update_goal_state (goal_handle : access rcl_action_goal_handle_t; goal_event : rcl_action_rcl_action_types_h.rcl_action_goal_event_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:139
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_goal_handle_get_info (goal_handle : access constant rcl_action_goal_handle_t; goal_info : access action_msgs_action_msgs_msg_detail_goal_info_ustruct_h.action_msgs_u_msg_u_GoalInfo) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:164
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_goal_handle_get_status (goal_handle : access constant rcl_action_goal_handle_t; status : access rcl_action_rcl_action_types_h.rcl_action_goal_state_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:189
   with Import => True, 
        Convention => C, 
  ...
  -- 
   ...
   function rcl_action_goal_handle_is_active (goal_handle : access constant rcl_action_goal_handle_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:213
   with Import => True, 
        Convention => C, 
  ...
  -- 
   ...
   function rcl_action_goal_handle_is_cancelable (goal_handle : access constant rcl_action_goal_handle_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:235
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_action_goal_handle_is_valid (goal_handle : access constant rcl_action_goal_handle_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl_action/rcl_action/goal_handle.h:262
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_action_goal_handle_is_valid";

end rcl_action_rcl_action_goal_handle_h;
