...
package rcutils_rcutils_time_h is
  ...
  --/ A single point in time, measured in nanoseconds since the Unix epoch.
   subtype rcutils_time_point_value_t is x86_64_linux_gnu_bits_stdint_intn_h.int64_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/time.h:48

  --/ A duration of time, measured in nanoseconds.
   subtype rcutils_duration_value_t is x86_64_linux_gnu_bits_stdint_intn_h.int64_t;  -- /opt/ros/jazzy/include/rcutils/rcutils/time.h:50
  ...
  --  
   ...
   function rcutils_system_time_now (now : access rcutils_time_point_value_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/time.h:77
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_steady_time_now (now : access rcutils_time_point_value_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/time.h:105
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_time_point_value_as_nanoseconds_string
     (time_point : access rcutils_time_point_value_t;
      ...
      str_size : stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/time.h:141
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcutils_time_point_value_as_date_string
     (time_point : access rcutils_time_point_value_t;
      str : Interfaces.C.Strings.chars_ptr;
      str_size : stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/time.h:172
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_time_point_value_as_date_string";
  ...
  --  
   ...
   function rcutils_time_point_value_as_seconds_string
     (time_point : access rcutils_time_point_value_t;
      str : Interfaces.C.Strings.chars_ptr;
      str_size : stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/time.h:211
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_time_point_value_as_seconds_string";

end rcutils_rcutils_time_h;
