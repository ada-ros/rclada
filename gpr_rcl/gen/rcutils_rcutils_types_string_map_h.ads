...
package rcutils_rcutils_types_string_map_h is
  ...
  --/ \file
   type rcutils_string_map_impl_s is null record;   -- incomplete struct

  --/ The structure holding the metadata for a string map.
  --/ A pointer to the PIMPL implementation type.
   type rcutils_string_map_s is record
      impl : access rcutils_string_map_impl_s;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:38
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:35

   subtype rcutils_string_map_t is rcutils_string_map_s;  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:39
  ...
  -- *  
   ...
   function rcutils_get_zero_initialized_string_map return rcutils_string_map_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:60
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_get_zero_initialized_string_map";
  ...
  --  
   ...
   function rcutils_string_map_init
     (string_map : access rcutils_string_map_t;
      ...
      allocator : rcutils_rcutils_allocator_h.rcutils_allocator_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:100
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_init";
  ...
  --  
   ...
   function rcutils_string_map_fini (string_map : access rcutils_string_map_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:118
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_fini";
  ...
  --  
   ...
   function rcutils_string_map_get_capacity (string_map : access constant rcutils_string_map_t; capacity : access stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:139
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_get_capacity";
  ...
  --  
   ...
   function rcutils_string_map_get_size (string_map : access constant rcutils_string_map_t; size : access stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:158
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_get_size";
  ...
  --  
   ...
   function rcutils_string_map_reserve (string_map : access rcutils_string_map_t; capacity : stddef_h.size_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:186
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_reserve";
  ...
  --  
   ...
   function rcutils_string_map_clear (string_map : access rcutils_string_map_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:203
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_clear";
  ...
  --  
   ...
   function rcutils_string_map_set
     (string_map : access rcutils_string_map_t;
      ...
      value : Interfaces.C.Strings.chars_ptr) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:224
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_set";
  ...
  --  
   ...
   function rcutils_string_map_set_no_resize
     (string_map : access rcutils_string_map_t;
      key : Interfaces.C.Strings.chars_ptr;
      value : Interfaces.C.Strings.chars_ptr) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:257
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_set_no_resize";
  ...
  --  
   ...
   function rcutils_string_map_unset (string_map : access rcutils_string_map_t; key : Interfaces.C.Strings.chars_ptr) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:278
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_unset";
  ...
  --  
   ...
   function rcutils_string_map_key_exists (string_map : access constant rcutils_string_map_t; key : Interfaces.C.Strings.chars_ptr) return Extensions.bool  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:297
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_key_exists";
  ...
  --  
   ...
   function rcutils_string_map_key_existsn
     (string_map : access constant rcutils_string_map_t;
      key : Interfaces.C.Strings.chars_ptr;
      key_length : stddef_h.size_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:314
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_key_existsn";
  ...
  --  
   ...
   function rcutils_string_map_get (string_map : access constant rcutils_string_map_t; key : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:344
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_get";
  ...
  --  
   ...
   function rcutils_string_map_getn
     (string_map : access constant rcutils_string_map_t;
      key : Interfaces.C.Strings.chars_ptr;
      key_length : stddef_h.size_t) return Interfaces.C.Strings.chars_ptr  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:362
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_getn";
  ...
  --  
   ...
   function rcutils_string_map_get_next_key (string_map : access constant rcutils_string_map_t; key : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:410
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_get_next_key";
  ...
  --  
   ...
   function rcutils_string_map_copy (src_string_map : access constant rcutils_string_map_t; dst_string_map : access rcutils_string_map_t) return rcutils_rcutils_types_rcutils_ret_h.rcutils_ret_t  -- /opt/ros/jazzy/include/rcutils/rcutils/types/string_map.h:435
   with Import => True, 
        Convention => C, 
        External_Name => "rcutils_string_map_copy";

end rcutils_rcutils_types_string_map_h;
