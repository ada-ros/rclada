...
limited with rcl_rcl_time_h;
with rcl_rcl_publisher_h;
with rcl_rcl_service_introspection_h;

package rcl_rcl_service_h is
  ...
  --/ Internal rcl implementation struct.
   type rcl_service_impl_s is null record;   -- incomplete struct

   subtype rcl_service_impl_t is rcl_service_impl_s;  -- /opt/ros/jazzy/include/rcl/rcl/service.h:39

  --/ Structure which encapsulates a ROS Service.
  --/ Pointer to the service implementation
   type rcl_service_s is record
      impl : access rcl_service_impl_t;  -- /opt/ros/jazzy/include/rcl/rcl/service.h:45
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/service.h:42

   subtype rcl_service_t is rcl_service_s;  -- /opt/ros/jazzy/include/rcl/rcl/service.h:46

  --/ Options available for a rcl service.
  --/ Middleware quality of service settings for the service.
   type rcl_service_options_s is record
      qos : aliased rmw_rmw_types_h.rmw_qos_profile_t;  -- /opt/ros/jazzy/include/rcl/rcl/service.h:52
      allocator : aliased rcl_rcl_allocator_h.rcl_allocator_t;  -- /opt/ros/jazzy/include/rcl/rcl/service.h:55
   end record
   with Convention => C_Pass_By_Copy;  -- /opt/ros/jazzy/include/rcl/rcl/service.h:49

  --/ Custom allocator for the service, used for incidental allocations.
  --* For default behavior (malloc/free), see: rcl_get_default_allocator()  
   subtype rcl_service_options_t is rcl_service_options_s;  -- /opt/ros/jazzy/include/rcl/rcl/service.h:56
  ...
  --  
   ...
   function rcl_get_zero_initialized_service return rcl_service_t  -- /opt/ros/jazzy/include/rcl/rcl/service.h:68
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_service_init
     (service : access rcl_service_t;
      ...
      type_support : access constant rosidl_runtime_c_rosidl_runtime_c_service_type_support_struct_h.rosidl_service_type_support_t;
      service_name : Interfaces.C.Strings.chars_ptr;
      options : access constant rcl_service_options_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/service.h:163
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_service_fini (service : access rcl_service_t; node : access rcl_rcl_node_h.rcl_node_s) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/service.h:199
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_service_get_default_options return rcl_service_options_t  -- /opt/ros/jazzy/include/rcl/rcl/service.h:211
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_take_request_with_info
     (service : access constant rcl_service_t;
      request_header : access rmw_rmw_types_h.rmw_service_info_s;
      ros_request : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/service.h:261
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_take_request
     (service : access constant rcl_service_t;
      ...
      ros_request : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/service.h:285
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_send_response
     (service : access constant rcl_service_t;
      ...
      ros_response : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/service.h:339
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_service_get_service_name (service : access constant rcl_service_t) return Interfaces.C.Strings.chars_ptr  -- /opt/ros/jazzy/include/rcl/rcl/service.h:369
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_service_get_options (service : access constant rcl_service_t) return access constant rcl_service_options_t  -- /opt/ros/jazzy/include/rcl/rcl/service.h:396
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_service_get_rmw_handle (service : access constant rcl_service_t) return access rmw_rmw_types_h.rmw_service_s  -- /opt/ros/jazzy/include/rcl/rcl/service.h:427
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_service_is_valid (service : access constant rcl_service_t) return Extensions.bool  -- /opt/ros/jazzy/include/rcl/rcl/service.h:449
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function rcl_service_request_subscription_get_actual_qos (service : access constant rcl_service_t) return access constant rmw_rmw_types_h.rmw_qos_profile_s  -- /opt/ros/jazzy/include/rcl/rcl/service.h:475
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_service_request_subscription_get_actual_qos";
  ...
  --  
   ...
   function rcl_service_response_publisher_get_actual_qos (service : access constant rcl_service_t) return access constant rmw_rmw_types_h.rmw_qos_profile_s  -- /opt/ros/jazzy/include/rcl/rcl/service.h:501
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_service_response_publisher_get_actual_qos";
  ...
  --  
   ...
   function rcl_service_set_on_new_request_callback
     (service : access constant rcl_service_t;
      ...
      user_data : System.Address) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/service.h:529
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_service_set_on_new_request_callback";
  ...
  --  
   ...
   function rcl_service_configure_service_introspection
     (service : access rcl_service_t;
      ...
      type_support : access constant rosidl_runtime_c_rosidl_runtime_c_service_type_support_struct_h.rosidl_service_type_support_t;
      publisher_options : rcl_rcl_publisher_h.rcl_publisher_options_t;
      introspection_state : rcl_rcl_service_introspection_h.rcl_service_introspection_state_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl/rcl/service.h:567
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_service_configure_service_introspection";

end rcl_rcl_service_h;
