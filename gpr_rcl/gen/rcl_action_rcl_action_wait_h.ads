...
limited with rcl_rcl_wait_h;
limited with rcl_action_rcl_action_action_client_h;
with stddef_h;
with rcl_rcl_types_h;
limited with rcl_action_rcl_action_action_server_h;
with Interfaces.C.Extensions;

package rcl_action_rcl_action_wait_h is
  ...
  -- 
   ...
   function rcl_action_wait_set_add_action_client
     (wait_set : access rcl_rcl_wait_h.rcl_wait_set_s;
      action_client : access constant rcl_action_rcl_action_action_client_h.rcl_action_client_s;
      client_index : access stddef_h.size_t;
      subscription_index : access stddef_h.size_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/wait.h:70
   with Import => True, 
        Convention => C, 
  ...
  -- 
   ...
   function rcl_action_wait_set_add_action_server
     (wait_set : access rcl_rcl_wait_h.rcl_wait_set_s;
      action_server : access constant rcl_action_rcl_action_action_server_h.rcl_action_server_s;
      service_index : access stddef_h.size_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/wait.h:111
   with Import => True, 
        Convention => C, 
  ...
  -- 
   ...
   function rcl_action_client_wait_set_get_num_entities
     (action_client : access constant rcl_action_rcl_action_action_client_h.rcl_action_client_s;
      ...
      num_services : access stddef_h.size_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/wait.h:148
   with Import => True, 
        Convention => C, 
  ...
  -- 
   ...
   function rcl_action_server_wait_set_get_num_entities
     (action_server : access constant rcl_action_rcl_action_action_server_h.rcl_action_server_s;
      ...
      num_timers : access stddef_h.size_t;
      num_clients : access stddef_h.size_t;
      num_services : access stddef_h.size_t) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/wait.h:188
   with Import => True, 
        Convention => C, 
  ...
  -- 
   ...
   function rcl_action_client_wait_set_get_entities_ready
     (wait_set : access constant rcl_rcl_wait_h.rcl_wait_set_s;
      action_client : access constant rcl_action_rcl_action_action_client_h.rcl_action_client_s;
      ...
      is_result_response_ready : access Extensions.bool) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/wait.h:232
   with Import => True, 
        Convention => C, 
  ...
  -- 
   ...
   function rcl_action_server_wait_set_get_entities_ready
     (wait_set : access constant rcl_rcl_wait_h.rcl_wait_set_s;
      ...
      is_goal_expired : access Extensions.bool) return rcl_rcl_types_h.rcl_ret_t  -- /opt/ros/jazzy/include/rcl_action/rcl_action/wait.h:273
   with Import => True, 
        Convention => C, 
        External_Name => "rcl_action_server_wait_set_get_entities_ready";

end rcl_action_rcl_action_wait_h;
